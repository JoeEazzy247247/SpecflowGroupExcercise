...
namespace SpecflowGroupExcercise.StepDefinitions
{
    ...
    public class FormsStepDefinitions
    {
        ...
        public async Task WhenIEnterTheFollowingDetails(Table table)
        {
            ...
            await _practiceFormPage.EnterFNameLNameEmail(table.Header.FirstOrDefault(), table.Header.ElementAt(1),
                table.Header.ElementAt(2), string.Format(enterDetails.firstName, DateTime.Now.ToString("HHmmssfff")),
                string.Format(enterDetails.lastName, DateTime.Now.ToString("HHmmssfff")), string.Format(enterDetails.userEmail,
        ...
        public async Task WhenIEnterMobileNumber(string MobileOption) =>
            await _practiceFormPage.EnterMobileNumber(MobileOption);
        ...
        [Then(@"I click on close btn")]
        public async Task ThenIClickOnCloseBtn() => await _practiceFormPage.ClickCloseBtn();
    }
}